...
const ThemeToggler: React.FC = () => {
  ...
  return (
    <button
      ...
      className="p-2 rounded-lg bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-transform duration-200"
    >
      {theme === "light" ? (
        <svg
